...
lines.push("`packages/shared/src/schemas.ts` (`@sepia/shared`). Regenerated by");
...
const sections: Record<string, string[]> = {
  ...
  manage_memory: [
    ...
    "",
    `- \`create\`: memory { content (1-4000), type? (${MEMORY_TYPES.join("|")}, default fact), importance? (0-1, default 0.5), namespace? (default "${DEFAULT_NAMESPACE}"), entity_ids? (uuid[], max ${MAX_ENTITY_LINKS}), metadata? ({}) }`,
